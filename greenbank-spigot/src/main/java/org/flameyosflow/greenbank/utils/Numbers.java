...
public final class Numbers {
    ...
    public static String shortCurrency(final BigDecimal value, final GreenBankMain gb) {
        if (gb.getSettings().isCurrencySymbolSuffixed()) {
            return formatAsCurrency(value) + gb.getSettings().getCurrencySymbol();
        }
        return gb.getSettings().getCurrencySymbol() + formatAsCurrency(value);
    }
    ...
    public static String displayCurrency(final BigDecimal value, final GreenBankMain gb) {
        ...
        if (gb.getSettings().isCurrencySymbolSuffixed()) {
            return sign + tl("currency", currency, gb.getSettings().getCurrencySymbol());
        }
        return sign + tl("currency", gb.getSettings().getCurrencySymbol(), currency);
    }

    public static String displayCurrencyExactly(final BigDecimal value, final GreenBankMain gb) throws InterruptedException, ExecutionException {
    ...
    public static String sanitizeCurrencyString(final String input, final GreenBankMain gb) {
        return input.replace(gb.getSettings().getCurrencySymbol(), "");
    }
