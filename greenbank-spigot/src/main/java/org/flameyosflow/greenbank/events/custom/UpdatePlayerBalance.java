package org.flameyosflow.greenbank.events.custom;
...
public class UpdatePlayerBalance extends Event {
    ...
    public UpdatePlayerBalance(final Player player, final BigDecimal originalBalance, final BigDecimal balance, final Cause cause) {
    ...
    public enum Cause {
        ...
        COMMAND_SELL,
        API,
        PLUGIN, // API but easier to understand
