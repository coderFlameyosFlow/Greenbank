...
**Please NOTE: this plugin is in development, and is open for contributions,
 although, it does not have a valid API, and it does not have a successful**
**connection to use in maven/gradle, please consider helping us with that :)**.

Features **potentially promised** on 1.0:
...
**Please note**:
- This is only supported on **Paper**, **spigot support will come soon**, but it's paper to **help you recommend Paper for your server**.
